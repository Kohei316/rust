...
use rustc_hir::{Crate, ItemLocalId, ItemLocalMap, PreciseCapturingArg, TraitCandidate};
...
rustc_queries! {
    ...
    query rendered_precise_capturing_args(def_id: DefId) -> Option<&'tcx [PreciseCapturingArg]> {
